...
class AppL10nRu extends AppL10n {
  ...
  String get preparingFirstRunBody =>
      'Разовая настройка — proof-of-work, чтобы личность нельзя было подделать. На компьютере это секунды, на телефоне — от нескольких минут. Выполняется только при первом запуске; дальнейшие переключения мгновенны.';
  ...
  String get onboardNoRecoveryPhrase =>
      'Это устройство не смогло выдать фразу восстановления, поэтому личность не создана. Без неё личность нельзя было бы восстановить — попробуйте ещё раз или восстановите существующую.';

  @override
  String get onboardRestoreIdentity => 'Восстановить личность';
  ...
  String get storageUnavailableBody =>
      'xVeil не смог загрузить компонент, который шифрует всё, что хранит. Без него приложение не запустится: иначе пароль ничего не защищал бы, а данные исчезали бы при закрытии.';

  @override
  String get storageUnavailableAction =>
      'Сборка повреждена или неполна. Установите xVeil заново со страницы релизов. То, что уже сохранено на этом устройстве, не тронуто.';

  @override
  String get startupFailedTitle => 'xVeil не смог запуститься';

  @override
  String get startupFailedBody =>
      'Что-то пошло не так, пока приложение готовилось к работе, — до того, как оно коснулось ваших данных. Ничего не открывалось, не записывалось и не отправлялось.';

  @override
  String get startupFailedAction =>
      'Закройте xVeil и откройте снова. Если это повторяется, установите его заново со страницы релизов.';
  ...
  String get lockWipeLeftNetwork =>
      'Сетевая часть не подтвердила остановку — туннель или узел могут работать, пока приложение не закрыто.';
  ...
  String get helpIntro =>
      'Короткие ответы на вопросы, которые вызывает это приложение. Никаких технических знаний не нужно.';

  @override
  String get helpWhatTitle => 'Что это такое?';

  @override
  String get helpWhatBody =>
      'Мессенджер, за которым не стоит компания. Нет сервера, который хранил бы ваши сообщения, нет учётной записи, и никто не спросил ни номера телефона, ни почты — потому что их некуда отправлять.\n\nВаши сообщения идут напрямую тому, кому вы пишете, или их передают дальше чужие копии этого же приложения, пока сообщение не дойдёт. Они запираются на вашем устройстве и открываются на устройстве собеседника, и никто по пути прочитать их не может.\n\nОтсюда одно следствие, о котором лучше знать сразу: раз никто ничего для вас не хранит, то и вернуть вам ничего не сможет. Существует то, что лежит на ваших устройствах.';

  @override
  String get helpIdentityTitle => 'Кто я здесь?';

  @override
  String get helpIdentityBody =>
      'При первом запуске приложение создало вам личность — длинную строку символов, это ваш адрес в сети. Себе вы можете дать имя; другие видят то имя, которое дали вам они.\n\nЕщё вы выбрали пароль. Он открывает не учётную запись где-то, а хранилище на ЭТОМ устройстве. Сбросить его никто не может, потому что ни у кого его нет.\n\nЕсли вам предлагали фразу для восстановления — запишите её на бумаге и держите в надёжном месте. Это единственный способ снова стать тем же человеком на новом устройстве.';

  @override
  String get helpContactsTitle => 'Как добавить человека?';

  @override
  String get helpContactsBody =>
      'Меню → Добавить контакт. Вы получите ссылку (и QR-код). Передайте её как угодно — другим мессенджером, фотографией экрана, запиской на бумаге.\n\nКогда человек её откроет, он сможет вам написать. Вы увидите запрос и решите, принимать ли.\n\nСсылка — это приглашение, а не номер телефона: новую можно сделать в любой момент, а старая, которой не воспользовались, ничем не вредит.';

  @override
  String get helpOfflineTitle => 'Написано «офлайн», или ничего не доходит';

  @override
  String get helpOfflineBody =>
      'Приложению нужен хотя бы один чужой узел, чтобы дотянуться до остальной сети. Если ни одного не нашлось, сверху появляется серая полоска, а ваши сообщения ждут — они не потеряны и уйдут, как только появится путь.\n\nОбычные причины:\n\n• Вы в сети, которая многое блокирует, — Wi-Fi в гостинице или на работе. Мобильный интернет обычно работает.\n• Телефон усыпил приложение. Откройте его и подождите немного.\n• Вы отключили общие входные узлы и не добавили своих. Тогда полоска красная и говорит именно об этом, а включить обратно можно в разделе «Сеть».\n\nСобеседник тоже должен быть достижим — хотя бы иногда. Сообщение человеку с выключенным телефоном дождётся его.';

  @override
  String get helpCallsTitle => 'Звонки';

  @override
  String get helpCallsBody =>
      'Голос и видео, в том же окне, что и переписка. Оба собеседника должны быть в сети одновременно — между вами нет никого, кто подержал бы звонок на потом.\n\nЗвонок, на который не ответили, оставляет строку в переписке, так что видно: вам звонили.\n\nЕсли звонок не соединяется, причина почти всегда та же, что и у недоходящих сообщений: сейчас нет пути до собеседника.';

  @override
  String get helpFilesTitle => 'Файлы и общие папки';

  @override
  String get helpFilesBody =>
      'Файл можно отправить в переписке, как сообщение. Большие идут по частям и продолжаются с того места, где прервались, — потеря связи не означает потерю файла.\n\nОбщая папка — это папка на ВАШЕМ устройстве, которую вы разрешили читать определённым людям. Никакого облака за ней нет: пока ваше устройство выключено, забрать из неё ничего нельзя.\n\nСсылку на папку можно отозвать. После этого она перестаёт работать даже у того, кто её сохранил.';

  @override
  String get helpIdentitiesTitle => 'Несколько личностей, несколько устройств';

  @override
  String get helpIdentitiesBody =>
      'В приложении может быть больше одной личности — отдельные имена, отдельные контакты, отдельное хранилище. Друг о друге они не знают, и со стороны нельзя понять, что они принадлежат одному человеку.\n\nК одной личности можно привязать и второе устройство: например, телефон и компьютер. Они передают сообщения друг другу, чтобы оба были в курсе.\n\nПереключение личности меняет всё сразу — переписки, файлы, настройки. Если не уверены, от кого пишете, посмотрите на имя вверху экрана.';

  @override
  String get helpPrivacyTitle =>
      'Что на самом деле делают настройки приватности';

  @override
  String get helpPrivacyBody =>
      'Анонимная маршрутизация ведёт ваш трафик через несколько чужих узлов, так что ни собеседник, ни наблюдатель не узнают ваш адрес. Это медленнее. Когда она включена, сверху видна полоска.\n\nПрямое соединение (P2P) — обратный размен: быстро, но собеседник узнаёт ваш адрес. Настраивается для каждого контакта и каждой личности.\n\nИсчезающие сообщения убирают сообщение у обеих сторон через заданное время. Это удобство, а не гарантия: тот, кто захочет сохранить написанное, всегда может сфотографировать экран.';

  @override
  String get helpLossTitle => 'Если потеряли устройство или забыли пароль';

  @override
  String get helpLossBody =>
      'Восстановления нет. Ни у нас, ни у кого-либо ещё — пароль нигде не хранится, и нет учётной записи, которую можно было бы сбросить.\n\nЗащищает подготовка: запишите фразу восстановления на бумаге и привяжите второе устройство, пока это возможно. На втором устройстве та же личность, поэтому потеря одного — неудобство, а не конец.\n\nЭто цена того самого, ради чего приложение и нужно: если бы мы могли вернуть ваши сообщения вам, мы могли бы отдать их и кому-то другому.';

  @override
  String get helpStuckTitle => 'Что-то не работает';

  @override
  String get helpStuckBody =>
      'Начните с раздела «Сеть». Там словами написано, запущен ли узел, со сколькими другими узлами вы соединены и что именно не так, если что-то не так.\n\nЕсли узлов ноль — посмотрите на полоску вверху экрана: она говорит, никого не нашлось или путь в сеть отключён.\n\nЕсли сообщение не уходит — оно ждёт, а не потерялось. Уйдёт, как только появится путь.';

  @override
  String get helpGoNetwork => 'Запущен ли узел и с кем вы соединены';

  @override
  String get helpGoSettings => 'Пароли, приватность, уведомления и внешний вид';
  ...
  @override
  String get spaceSealHistoryTitle => 'Запечатать раннюю историю';

  @override
  String get spaceSealHistoryHint =>
      'Подтвердить как владелец операции, которые сообщество уже применило, — чтобы порядок перестал решать за них заново.';

  @override
  String get spaceSealHistoryConfirm =>
      'Журнал управления упорядочен без часов: дату ставит тот, кто пишет строку. У строк, написанных до этого порядка, нет ссылки на повышение, которое их разрешило, — и действие модератора может быть прочитано как неразрешённое.\n\nПечать записывает ваше слово владельца обо всём, что это устройство приняло к настоящему моменту. Она не отменяет уже вынесенных здесь решений и никому не даёт новых прав: подписи, цепочки и отозванные полномочия действуют по-прежнему. Она лишь прекращает задавать этот вопрос снова.';

  @override
  String get spaceSealHistoryAction => 'Запечатать';

  @override
  String get spaceSealHistoryDone => 'Ранняя история запечатана.';
  ...
  @override
  String get chatRequestResent => 'Отправлено ещё раз — ожидание одобрения';
  ...
  @override
  String get attachmentPreviewPhoto => 'Фото';

  @override
  String get attachmentPreviewVideo => 'Видео';

  @override
  String get attachmentPreviewSticker => 'Стикер';
  ...
  @override
  String get chatHideAfterReadTitle => 'Скрывать после прочтения';

  @override
  String get chatHideAfterReadSubtitle =>
      'Отсчёт от момента, когда КАЖДОЕ устройство впервые показало сообщение, поэтому моменты разные. Сообщение скрывается, а не удаляется, и устройство вправе не подчиниться — отметок о прочтении здесь нет, и заставить нечем.';
  ...
  String get settingsStorageCompactBody =>
      'Освободить неиспользуемое место — приложение переоткроется. Сжатие сохраняет только те личности, чьи пароли вы ему дадите, поэтому на следующем шаге нужно назвать каждую в этом контейнере. Неназванное будет отброшено.';
  ...
  String get settingsRecoveryBundleNoCopy =>
      'Ваши 24 слова открывают ключ этой личности, но не воспроизводят его: половина ключа существует только внутри этого устройства. Выпустите сертификат восстановления, чтобы копия появилась.';

  @override
  String get settingsRecoveryPhraseOnly =>
      'Эта личность выведена из ваших 24 слов, и они восстанавливают её в точности.';

  @override
  String get settingsRecoveryNothing =>
      'Вне этого устройства эту личность не восстановит ничто. Держите архив с личностью или выпустите сертификат восстановления.';
  ...
  String get nodeAutoUpdateHint =>
      'Сервер раз в сутки проверяет новый релиз veil и ставит его от root, без присмотра. Рекомендуем обновлять осознанно: это доверие тому, кто может выпустить релиз, — отпечаток, который сверяется, публикуется рядом с файлом. Прежний файл сохраняется и возвращается, если узел не поднялся.';
  ...
  String get exitAdmissionUnreadable =>
      'Конфигурацию не удалось разобрать: список выхода занимает несколько строк или таблица встречается дважды. Отредактируйте текст ниже.';
  ...
  String get devicesQrTooLarge =>
      'Этот код слишком длинный для QR-кода. Скопируйте его и вставьте на другом устройстве или отправьте зашифрованную настройку по сети.';
  ...
  @override
  String get onboardCertFreshTitle => 'Ваша личность и единственный ключ к ней';

  @override
  String get onboardCertFreshWhy =>
      'Личность только что создана. Её ключ существует в одном месте — в сертификате ниже — и открывается одним секретом: кодом рядом с ним. Сохраните оба, храня их порознь, прежде чем идти дальше. Другой копии не будет.';

  @override
  String get onboardCertFreshFailed =>
      'Создать личность на этом устройстве не удалось, поэтому она и не создана. Ничего не записано. Вернитесь и попробуйте снова; если повторяется — эта сборка не может добраться до компонента, который делает ключи.';

  @override
  String get onboardCertFreshMustSave =>
      'Сначала сохраните сертификат в файл. Он существует только на этом экране, и больше ничто эту личность не восстановит.';
  ...
  String get onboardCertWhy =>
      'Эта личность названа ключом из двух половин. Ваши 24 слова задают одну; вторая берётся случайно и существует только в сертификате восстановления. Одни слова этот адрес НЕ вернут: восстановление без сертификата даёт другую личность, и никто из знающих вас до неё не достучится. Сделайте сертификат сейчас.';

  @override
  String get onboardCertRolePhrase =>
      '24 слова — половина ключа и пароль к сертификату. Сами по себе они восстанавливают ДРУГУЮ личность, не эту.';

  @override
  String get onboardCertRoleFile =>
      'Сертификат — единственная полная копия ключа. Только он возвращает тот адрес, который есть у ваших контактов.';
  ...
  String get onboardCertLater =>
      'Это можно сделать позже: Настройки → Устройства → «Создать сертификат восстановления». Там спросят те 24 слова, которые вы сохранили. Пока сертификата нет, потеря всех устройств — это потеря этой личности — одни слова её не вернут.';
  ...
  String get devicesRevokeKeyStillCertified =>
      'Не отозвано: документ личности всё ещё заверяет ключ этого устройства. Повторите с удостоверением, которому принадлежит личность.';

  @override
  String get devicesDocumentNotAmended =>
      'Не связано: документ личности не удалось обновить, поэтому устройство не добавлено. Повторите с удостоверением, которому принадлежит эта личность.';
  ...
  String get backupNotExcludedTitle =>
      'Это устройство может копировать ваши данные в резервную копию';
  ...
  String get seedsChoiceBody =>
      'У xVeil нет центрального сервера и нет списка входных узлов, поэтому новому устройству нужен хотя бы один достижимый узел. Выберите, можно ли этой личности искать его самой.';

  @override
  String get seedsUseTitle => 'Искать доступные узлы (рекомендуется)';

  @override
  String get seedsUseBody =>
      'Приложение найдёт вход само, настраивать нечего. Оно спрашивает открытый указатель, которым никто не управляет, и тот, кого оно спросит, узнает адрес этого устройства. Не кто вы.';
  ...
  String get seedsDeclineBody =>
      'Для этой личности приложение ничего не ищет и никого не спрашивает, поэтому посторонние не узнают о её существовании. Другие ваши личности это не затрагивает. Ничего не работает, пока вы не добавите узел сами: сообщения не отправятся и не придут.';
  ...
  String get seedsReofferBody =>
      'Вы выбрали пользоваться только узлами, которые добавите сами, и ни одного не добавлено. Пока его нет, сообщения не отправляются и не приходят. Можно добавить свой узел сейчас или разрешить приложению искать: оно спрашивает открытый указатель, которым никто не управляет, и тот, кого оно спросит, узнает адрес, с которого подключается это устройство. Выбор относится только к этой личности.';

  @override
  String get seedsReofferUse => 'Искать узлы';
  ...
  String get seedsNoNodeBody =>
      'Эта личность не ищет узлы, поэтому ей нужен ваш собственный. Добавьте его — и приложение подключится.';
  ...
  String get seedsRestartToApply =>
      'Выбор сохранён для этой личности, но перезапустить работающий узел не удалось. Закройте приложение и откройте снова, чтобы подключиться.';
  ...
  @override
  String get dhtServeTitle => 'Обслуживать сеть';

  @override
  String get dhtServeOnSub =>
      'Устройство хранит чужие записи и водит чужие обходы. На простаивающем клиенте это около 85% всего входящего. Так данные сети лежат на многих машинах, а не на нескольких.';

  @override
  String get dhtServeOffSub =>
      'Пиров просят не выбирать это устройство для своего хранения и поиска. Ваши сообщения, контакты и доставка не затронуты. Данные сети при этом держат меньше машин.';

  @override
  String get dhtServeSaveFailed => 'Не удалось сохранить настройку';

  @override
  String get seedsSwitchTitle => 'Искать доступные узлы';

  @override
  String get seedsSwitchOnSub =>
      'Включено для этой личности: приложение находит сеть само, спрашивая открытый указатель, которым никто не управляет. Тот, кого оно спросит, узнает адрес, с которого подключается это устройство.';

  @override
  String get seedsSwitchOffSub =>
      'Выключено для этой личности: только узлы, которые вы добавите сами. Ничего не подключится, пока вы не добавите хотя бы один. Другие ваши личности не затронуты.';
  ...
  String get transferIncludeIdentityHint =>
      'Чистая установка станет этим устройством из одного архива. Ключ личности едет запертым: чтобы его открыть, понадобится ваш секрет.';

  @override
  String get transferIdentityNeedsCode =>
      'Чтобы восстановить личность из этого архива, понадобится ВАШ КОД ВОССТАНОВЛЕНИЯ — тот, что вы хранили рядом с сертификатом. В файле его нет, и это не пароль архива. Без него архив восстановит переписку и другую личность.';

  @override
  String get transferIdentityNeedsPhrase =>
      'Чтобы восстановить личность из этого архива, понадобятся ВАШИ 24 СЛОВА. В файле их нет, и это не пароль архива. Без них архив восстановит переписку и другую личность.';
