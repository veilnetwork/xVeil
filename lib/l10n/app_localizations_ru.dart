...
class AppL10nRu extends AppL10n {
  ...
  String get onboardCertFreshWhy =>
      'Личность только что создана. Её ключ существует в одном месте — в сертификате ниже — и открывается одним секретом: кодом рядом с ним. Никаких 24 слов записывать не нужно: слова задавали бы лишь половину этого ключа, вторая берётся случайно, и по ним восстановилась бы другая личность. Сохраните оба, отдельно друг от друга, прежде чем идти дальше.';
