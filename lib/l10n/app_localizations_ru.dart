...
class AppL10nRu extends AppL10n {
  ...
  String get seedsDeclineBody =>
      'Ради этой личности ни один общий узел не будет опрошен, поэтому чужой сервер не узнает, что она существует. Другие ваши личности это не затрагивает. До того как вы добавите свой узел, не работает ничего: сообщения не уйдут и не придут.';
  ...
  String get seedsReofferBody =>
      'Вы выбрали пользоваться только своими узлами, но ни одного не добавили. Пока его нет, сообщения не отправляются и не приходят. Можно добавить свой узел сейчас — или всё-таки взять общие входные узлы: они узнают, что ваш узел существует и с какого адреса подключается. Что бы вы ни выбрали, ответ сохранится только для этой личности.';
  ...
  String get seedsSwitchOnSub =>
      'Включено для этой личности: приложение само находит сеть. Узлы проекта узнают, что ваш узел существует и с какого адреса он подключается.';

  @override
  String get seedsSwitchOffSub =>
      'Выключено для этой личности: только узлы, которые вы добавите сами. Пока такого узла нет, соединения не будет. Другие ваши личности это не затрагивает.';
