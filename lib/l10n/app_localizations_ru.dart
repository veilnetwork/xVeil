...
class AppL10nRu extends AppL10n {
  ...
  String get recoveryBody =>
      'Эти 24 слова — ПОЛОВИНА ключа вашей личности и пароль к сертификату восстановления. Не вся личность: вторая половина выбрана случайно при её создании и существует только в сертификате, поэтому одни слова возвращают ДРУГУЮ личность, по адресу, которого нет ни у кого из знающих вас. Запишите их на бумаге и храните надёжно — следом будет сертификат, и именно он возвращает эту личность. Ни то, ни другое не храните в сети и не фотографируйте.';
