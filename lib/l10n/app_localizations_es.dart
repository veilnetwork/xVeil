...
class AppL10nEs extends AppL10n {
  ...
  String get helpIntro =>
      'Respuestas breves a las preguntas que plantea esta aplicación. No hace falta ningún conocimiento técnico.';

  @override
  String get helpWhatTitle => '¿Qué es esto?';

  @override
  String get helpWhatBody =>
      'Un mensajero sin ninguna empresa detrás. No hay servidor que guarde tus mensajes, no hay cuenta, y nadie te pidió el teléfono ni el correo: no hay adónde enviarlos.\n\nTus mensajes van directos a la persona a la que escribes, o los reenvían copias de esta misma aplicación en otros dispositivos hasta que llegan. Se cierran en tu dispositivo y se abren en el suyo, y nadie por el camino puede leerlos.\n\nDe ahí una consecuencia que conviene saber desde el principio: como nadie guarda nada por ti, nadie puede devolvértelo. Existe lo que está en tus dispositivos.';

  @override
  String get helpIdentityTitle => '¿Quién soy aquí?';

  @override
  String get helpIdentityBody =>
      'Al abrir la aplicación por primera vez se creó una identidad: una cadena larga de caracteres que es tu dirección en esta red. Puedes darle un nombre para ti; los demás ven el nombre que ellos te pusieron.\n\nTambién elegiste una contraseña. No abre una cuenta en algún sitio: abre el almacenamiento de ESTE dispositivo. Nadie puede restablecerla, porque nadie más la tiene.\n\nSi te ofrecieron una frase de recuperación, escríbela en papel y guárdala bien. Es la única forma de volver a ser la misma persona en un dispositivo nuevo.';

  @override
  String get helpContactsTitle => '¿Cómo añado a alguien?';

  @override
  String get helpContactsBody =>
      'Menú → Añadir contacto. Obtienes un enlace (y un código QR). Envíaselo como quieras: por otro mensajero, una foto de la pantalla, una nota en papel.\n\nCuando lo abra, podrá escribirte. Verás la solicitud y decidirás si la aceptas.\n\nUn enlace es una invitación, no un número de teléfono: puedes crear uno nuevo cuando quieras, y uno antiguo sin usar no hace ningún daño.';

  @override
  String get helpOfflineTitle => 'Dice sin conexión, o no llega nada';

  @override
  String get helpOfflineBody =>
      'La aplicación necesita al menos otro nodo para alcanzar el resto de la red. Si no encuentra ninguno, aparece una franja gris arriba y tus mensajes esperan: no se pierden y salen en cuanto haya una ruta.\n\nLas razones habituales:\n\n• Estás en una red que bloquea mucho: wifi de hotel o de oficina. Los datos móviles suelen funcionar.\n• El teléfono durmió la aplicación. Ábrela y dale un momento.\n• Desactivaste los nodos de entrada compartidos y no añadiste ninguno propio. Entonces la franja lo dice en rojo, y se vuelven a activar en Red.\n\nLa otra persona también tiene que ser alcanzable en algún momento. Un mensaje a alguien con el teléfono apagado le espera.';

  @override
  String get helpCallsTitle => 'Llamadas';

  @override
  String get helpCallsBody =>
      'Voz y vídeo, en la misma ventana que el chat. Ambos tenéis que estar en línea a la vez: no hay nada en medio que guarde una llamada para después.\n\nUna llamada que nadie contestó deja una línea en la conversación, para que se vea que alguien lo intentó.\n\nSi una llamada no conecta, casi siempre es por lo mismo que cuando no llegan los mensajes: ahora no hay ruta hasta la otra parte.';

  @override
  String get helpFilesTitle => 'Archivos y carpetas compartidas';

  @override
  String get helpFilesBody =>
      'Puedes enviar un archivo en un chat como un mensaje. Los grandes viajan por partes y continúan donde se quedaron, así que perder la conexión no es perder el archivo.\n\nUna carpeta compartida es una carpeta de TU dispositivo que dejas leer a ciertas personas. No hay ninguna nube detrás: mientras tu dispositivo esté apagado, nadie puede sacar nada de ella.\n\nUn enlace a una carpeta se puede retirar. Después deja de funcionar, incluso para quien lo hubiera guardado.';

  @override
  String get helpIdentitiesTitle => 'Varias identidades, varios dispositivos';

  @override
  String get helpIdentitiesBody =>
      'Puedes tener más de una identidad: nombres, contactos y almacenamiento separados. No saben nada la una de la otra, y desde fuera no se puede saber que son de la misma persona.\n\nTambién puedes vincular un segundo dispositivo a la misma identidad: un teléfono y un ordenador, por ejemplo. Se pasan los mensajes para que ambos estén al día.\n\nCambiar de identidad lo cambia todo a la vez: chats, archivos, ajustes. Si dudas desde cuál escribes, mira el nombre de arriba.';

  @override
  String get helpPrivacyTitle =>
      'Qué hacen de verdad los ajustes de privacidad';

  @override
  String get helpPrivacyBody =>
      'El enrutado anónimo manda tu tráfico por varios nodos ajenos, de modo que ni la otra persona ni quien observe aprenden tu dirección. Es más lento. Cuando está activo hay una franja arriba.\n\nLa conexión directa (P2P) es el intercambio contrario: rápida, y la otra parte aprende tu dirección. Se ajusta por contacto y por identidad.\n\nLos mensajes que desaparecen se borran en ambos lados pasado el tiempo que fijes. Es una comodidad, no una garantía: quien quiera conservar lo que enviaste siempre puede fotografiar la pantalla.';

  @override
  String get helpLossTitle =>
      'Si pierdes el dispositivo u olvidas la contraseña';

  @override
  String get helpLossBody =>
      'No hay recuperación. Ni por nuestra parte ni por la de nadie: la contraseña no se guarda en ningún sitio y no hay cuenta que restablecer.\n\nLo que protege es la preparación: escribe la frase de recuperación en papel y vincula un segundo dispositivo mientras puedas. El segundo dispositivo lleva la misma identidad, así que perder uno es una molestia y no un final.\n\nEs el precio de aquello que hace útil a esta aplicación: si pudiéramos devolverte tus mensajes, también podríamos dárselos a otro.';

  @override
  String get helpStuckTitle => 'Algo no funciona';

  @override
  String get helpStuckBody =>
      'Empieza por Red. Ahí se dice con palabras si el nodo está en marcha, con cuántos nodos estás conectado y qué falla, si falla algo.\n\nSi hay cero nodos, mira la franja de arriba: dice si no se encontró a nadie o si la entrada a la red está desactivada.\n\nSi un mensaje no sale, está esperando, no perdido. Saldrá en cuanto haya una ruta.';

  @override
  String get helpGoNetwork =>
      'Si el nodo está en marcha y con quién estás conectado';

  @override
  String get helpGoSettings =>
      'Contraseñas, privacidad, notificaciones y apariencia';
  ...
  @override
  String get callKindVoice => 'Llamada de voz';

  @override
  String get callKindVideo => 'Videollamada';

  @override
  String get callOutcomeCompleted => 'Llamada,';
  ...
  @override
  String get chatRequestResent => 'Enviado de nuevo — esperando aprobación';
  ...
  String get updateCheckChoiceNotSaved =>
      'No se pudo guardar esta elección y volverá al estado anterior tras reiniciar.';
  ...
  String get oproxyShareAdmissionHint =>
      'El enlace dice por qué nodo salir. Si le dejan pasar se decide en el servidor: añade su node id a la lista de la salida, o el enlace le dará un rechazo.';

  @override
  String get oproxyShareSend => 'Enviar a un contacto';
  ...
  String onboardRestoreCertificateChosen(String id) {
    return 'Certificado de la identidad $id…';
  }

  @override
  String get onboardRestoreCodeLabel => 'Código de recuperación';
