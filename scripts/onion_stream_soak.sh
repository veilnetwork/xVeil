...
SOAK_ONION_STREAM_STRIPE_ROUTES="${SOAK_ONION_STREAM_STRIPE_ROUTES:-}"
SOAK_DESKTOP_ONION_STREAM_STRIPE_ROUTES="${SOAK_DESKTOP_ONION_STREAM_STRIPE_ROUTES:-$SOAK_ONION_STREAM_STRIPE_ROUTES}"
SOAK_ANDROID_ONION_STREAM_STRIPE_ROUTES="${SOAK_ANDROID_ONION_STREAM_STRIPE_ROUTES:-$SOAK_ONION_STREAM_STRIPE_ROUTES}"
...
validate_nonnegative_int SOAK_ONION_STREAM_STRIPE_ROUTES "$SOAK_ONION_STREAM_STRIPE_ROUTES"
validate_nonnegative_int SOAK_DESKTOP_ONION_STREAM_STRIPE_ROUTES "$SOAK_DESKTOP_ONION_STREAM_STRIPE_ROUTES"
validate_nonnegative_int SOAK_ANDROID_ONION_STREAM_STRIPE_ROUTES "$SOAK_ANDROID_ONION_STREAM_STRIPE_ROUTES"
...
if [[ -n "$SOAK_ONION_STREAM_STRIPE_ROUTES" ]]; then
  echo "onion stream stripe routes: $SOAK_ONION_STREAM_STRIPE_ROUTES"
fi
...
if [[ -n "$SOAK_ANDROID_ONION_STREAM_STRIPE_ROUTES" ]]; then
  adb -s "$ANDROID_SERIAL" shell setprop debug.veil.onion_stream_stripe_routes "$SOAK_ANDROID_ONION_STREAM_STRIPE_ROUTES"
else
  adb -s "$ANDROID_SERIAL" shell setprop debug.veil.onion_stream_stripe_routes 1
fi
...
(
  ...
  VEIL_FFI_DYLIB="$DESKTOP_DYLIB" \
    ...
    VEIL_ONION_STREAM_CIRCUIT_STRIPE_ROUTES="$SOAK_DESKTOP_ONION_STREAM_STRIPE_ROUTES" \
